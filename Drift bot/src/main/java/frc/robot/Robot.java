...
public class Robot extends TimedRobot {
  ...
  private DifferentialDrive m_drive1;
  ...
  public void robotInit() {
    ...
    m_drive1 = new DifferentialDrive(m_left, m_right);
  }
  ...
  public void teleopInit() {
    // m_robotDrive.arcadeDrive(m_controller.getY(GenericHID.Hand.kLeft),
  ...
  public void teleopPeriodic() {
    // m_drive1.tankDrive(m_controller.getY(GenericHID.Hand.kLeft),
